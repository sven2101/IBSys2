...
var NewBaumService = (function () {
    function NewBaumService() {
        this.erzeugeKinderBaum();
        this.erzeugeDamenBaum();
        this.erzeugeHerrenBaum();
    }
    NewBaumService.prototype.erzeugeKinderBaum = function () {
    ...
    NewBaumService.prototype.erzeugeDamenBaum = function () {
    ...
    NewBaumService.prototype.erzeugeHerrenBaum = function () {
    ...
    return NewBaumService;
})();
angular.module('app').factory('NewBaumService', [function () { return new NewBaumService(); }]);
