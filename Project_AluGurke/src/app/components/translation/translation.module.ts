...
angular.module('app').config(function($translateProvider) {
    ...
    $translateProvider.translations('de_DE', {
        ...
        dashboard_loadFile:'Nutze dein Dashboard!',
        ...
        dashboard_welcome:'Herzlich Wilkommen bei SCManager.de!',
        dashboard_tyRegister:'Vielen Dank, dass Sie sich für SCManager.de registriert haben!',
        dashboard_firstSteps:'Erste Schritte',
        dashboard_step:'Schritt',
        dashboard_fileUpload:'Datei hochladen',
        dashboard_fileText:'Einfach eine gültige XML-Datei hochladen und schon kannst du mit deiner Produktionsplanung beginnen!',
        dashboard_goToFileMgmt:'Zur Dateiverwaltung',
        dashboard_productionplan:'Lege deine Produktion fest',
        dashboard_productionplanText:'Produktionsprogramm bestimmen und weiter geht\'s!',
        dashboard_goToProductionplan:'Zum Produktionsprogramm',
        dashboard_disposition:'Organisiere deine Produktion',
        dashboard_dispositionText:'Gib deinen geplanten Lagerendstand an, splitte deine Aufträge und priorisiere sie anschlie\u00dfend mittels drag \'n drop.',
        dashboard_goToDisposition:'Zur Disposition',
        dashboard_orderMgmt:'Bestellung aufgeben',
        dashboard_orderMgmtText:'Dir gehen die Teile f\u00fcr die Produktion aus? Kein Problem! Mithilfe der intuitiven Bestellverwaltung kannst du genau sehen an welchen Kaufteilen es mangelt und vorgeschlagene Bestellungen \u00fcbernehmen oder selbst aufgeben.',
        dashboard_goToOrderMgmt:'Zur Bestellverwaltung',
        dashboard_capacity:'Plane deine Kapazit\u00e4ten',
        dashboard_capacityText:'Bestimme genau an welchen Arbeitspl\u00e4tzen du eine zus\u00e4tzliche Schicht oder \u00fcberstunden ben\u00f6tigst.',
        dashboard_goToCapacity:'Zur Kapazit\u00e4tsplanung',
        dashboard_createFile:'Erstelle deine Simulationsdatei',
        dashboard_createFileText:'Herzlichen Gl\u00fcckwunsch! Nun kannst du deine Simulationsdatei herunterladen und die Periode simulieren.',
    ...
    $translateProvider.translations('en_US', {
        ...
        dashboard_loadFile:'Use your Dashboard!',
        ...
        dashboard_welcome:'Welcome to SCManager.de!',
        dashboard_tyRegister:'Thanks for register your SCManager!',
        dashboard_firstSteps:'First steps',
        dashboard_step:'Step',
        dashboard_fileUpload:'File upload',
        dashboard_fileText:'Upload a valid XML-file and you can start your production planning!',
        dashboard_goToFileMgmt:'Go to file management',
        dashboard_productionplan:'Set your production',
        dashboard_productionplanText:'Set your production plan and go to the next Step.',
        dashboard_goToProductionplan:'Go to production plan',
        dashboard_disposition:'Organize your production',
        dashboard_dispositionText:'Set your planned final score inventory, split your orders and prioritise by drag \'n drop!',
        dashboard_goToDisposition:'Go to material planning',
        dashboard_orderMgmt:'Place an order',
        dashboard_orderMgmtText:'You need more components? No problem! The intuitively order management displays the components you need. So you can adopt the proposals or place an order by yourself.',
        dashboard_goToOrderMgmt:'Go to order management',
        dashboard_capacity:'Plan your capacity',
        dashboard_capacityText:'Determine the working place you need to shift work or add overtime.',
        dashboard_goToCapacity:'Go to capacity planning',
        dashboard_createFile:'Create your simulationfile',
        dashboard_createFileText:'Congratulation! Now you can download your simulationfile and simulate the current period!',
