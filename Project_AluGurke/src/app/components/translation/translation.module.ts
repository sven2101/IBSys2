...
angular.module('app').config(function($translateProvider) {
    ...
    $translateProvider.translations('de_DE', {
        ...
        dashboard_averageStorevalue:'Lagerwert',
        dashboard_storagecosts:'Lagerkosten',
        dashboard_storageFee:'Prognostizierter Lagerkostensatz',
    ...
    $translateProvider.translations('en_US', {
        ...
        dashboard_averageStorevalue:'Stock value',
        dashboard_storagecosts:'Storage costs',
        dashboard_storageFee:'Predicted Storage fee',
