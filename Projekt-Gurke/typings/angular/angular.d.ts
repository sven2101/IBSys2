...
declare module angular {
    ...
    // All BestellPositionService providers extend this interface
    ...
    interface IModule {
         ...
         *
         * @param configFn Execute this function on module load. Useful for BestellPositionService configuration.
         */
        config(configFn: Function): IModule;
        /**
         * Use this method to register work which needs to be performed on module loading.
         *
         * @param inlineAnnotatedFunction Execute this function on module load. Useful for BestellPositionService configuration.
         */
        config(inlineAnnotatedFunction: any[]): IModule;
        /**
         * Register a constant BestellPositionService, such as a string, a number, an array, an object or a function, with the $injector. Unlike value it can be injected into a module configuration function (see config) and it cannot be overridden by an Angular decorator.
         *
        ...
        /**
         * The $controller BestellPositionService is used by Angular to create new controllers.
         *
        ...
        /**
         * Register a BestellPositionService factory, which will be called to return the BestellPositionService instance. This is short for registering a BestellPositionService where its provider consists of only a $get property, which is the given BestellPositionService factory function. You should use $provide.factory(getFn) if you do not need to configure your BestellPositionService in a provider.
         *
        ...
        /**
         * Run blocks are the closest thing in Angular to the main method. A run block is the code which needs to run to kickstart the application. It is executed after all of the BestellPositionService have been configured and the injector has been created. Run blocks typically contain code which is hard to unit-test, and for this reason should be declared in isolated modules, so that they can be ignored in the unit-tests.
         */
        ...
        /**
         * Register a value BestellPositionService with the $injector, such as a string, a number, an array, an object or a function. This is short for registering a BestellPositionService where its provider's $get property is a factory function that takes no arguments and returns the value BestellPositionService.
    ...
    /**
     * $rootScope - $rootScopeProvider - BestellPositionService in module ng
     * see https://docs.angularjs.org/api/ng/type/$rootScope.Scope and https://docs.angularjs.org/api/ng/BestellPositionService/$rootScope
     */
    ...
    /**
     * $location - $locationProvider - BestellPositionService in module ng
     * see https://docs.angularjs.org/api/ng/BestellPositionService/$location
     */
    ...
    /**
     * $q - BestellPositionService in module ng
     * A promise/deferred implementation inspired by Kris Kowal's Q.
     * See http://docs.angularjs.org/api/ng/BestellPositionService/$q
     */
    interface IQService {
    ...
    /**
     * HttpService
     * see http://docs.angularjs.org/api/ng/BestellPositionService/$http
     */
    ...
    /**
     * Object describing the request to be made and how it should be processed.
     * see http://docs.angularjs.org/api/ng/BestellPositionService/$http#usage
     */
     ...
     * https://docs.angularjs.org/api/ng/BestellPositionService/$http#defaults
     */
    ...
    // You should never need to use this BestellPositionService directly.
    ///////////////////////////////////////////////////////////////////////////
    ...
    /**
     * $templateRequest BestellPositionService
     * see http://docs.angularjs.org/api/ng/BestellPositionService/$templateRequest
     */
    ...
    export module auto {
        ...
        interface IProvideService {
            ...
            /**
             * Register a BestellPositionService decorator with the $injector. A BestellPositionService decorator intercepts the creation of a BestellPositionService, allowing it to override or modify the behaviour of the BestellPositionService. The object returned by the decorator may be the original BestellPositionService, or a new BestellPositionService object which replaces or wraps and delegates to the original BestellPositionService.
             *
             * @param name The name of the BestellPositionService to decorate.
             * @param decorator This function will be invoked when the BestellPositionService needs to be instantiated and should return the decorated BestellPositionService instance. The function is called using the injector.invoke method and is therefore fully injectable. Local injection arguments:
             *
             * $delegate - The original BestellPositionService instance, which can be monkey patched, configured, decorated or delegated to.
             */
             ...
             *
             * @param name The name of the BestellPositionService to decorate.
             * @param inlineAnnotatedFunction This function will be invoked when the BestellPositionService needs to be instantiated and should return the decorated BestellPositionService instance. The function is called using the injector.invoke method and is therefore fully injectable. Local injection arguments:
             *
             * $delegate - The original BestellPositionService instance, which can be monkey patched, configured, decorated or delegated to.
             */
