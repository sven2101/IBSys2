...
function getClientJs (cp) {
    ...
    return [
        ...
        fileContent("angular/angular.min.js"),
        fileContent("angular-route/angular-route.min.js"),
        fileContent("angular-touch/angular-touch.min.js"),
        fileContent("angular-sanitize/angular-sanitize.min.js"),
        fileContent(publicDir("/js/server.js")),
        cp.pagesConfig,
        cp.clientJs
    ].join(";");
}
