...
```
9 Dec 23:52:58 - [nodemon] starting `node ./server.js fixtures/sigint.js`
```
...
For example, on `lib/server.js` being changed:

```text
14 Apr 15:25:56 - [nodemon] files triggering change check: ../jsbin/lib/server.js
...
14 Apr 15:25:56 - [nodemon] ../jsbin/lib/server.js
